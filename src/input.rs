...
pub fn to_numcode(v: u8) -> NumCode {
    match v {
        ...
        0x52 => NumCode::Insert,
        0x53 => NumCode::Delete,
        0x45 => NumCode::NumLock,
        0x46 => NumCode::ScrollLock,
        0x47 => NumCode::Home,
        0x4f => NumCode::End,
        0x49 => NumCode::PgUp,
        0x51 => NumCode::PgDn,
        0x0c => NumCode::Minus,
        0x0d => NumCode::Equals,
        0x1a => NumCode::LeftBracket,
        0x1b => NumCode::RightBracket,
        0x3b => NumCode::F1,
        0x3c => NumCode::F2,
        0x3d => NumCode::F3,
        0x3e => NumCode::F4,
        ...
        0x15 => NumCode::Y,
        0x2c => NumCode::Z,
        0x27 => NumCode::Semicolon,
        0x2b => NumCode::Backslash,
        0x33 => NumCode::Comma,
        0x34 => NumCode::Period,
        0x35 => NumCode::Slash,
        0x4e => NumCode::Plus,
