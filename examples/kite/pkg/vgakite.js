...
export function start_kite_web() {
    wasm.start_kite_web();
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbindgen_cast_ff916d72c32ba91e = function() { return logError(function (arg0, arg1) {
        // Cast intrinsic for `Closure(Closure { dtor_idx: 26, function: Function { arguments: [NamedExternref("Event")], shim_idx: 24, ret: Unit, inner_ret: Some(Unit) }, mutable: false }) -> Externref`.
        const ret = makeClosure(arg0, arg1, 26, __wbg_adapter_9);
        return ret;
    }, arguments) };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('vgakite_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
