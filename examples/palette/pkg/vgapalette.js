...
export function start_palette_web() {
    wasm.start_palette_web();
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbindgen_cast_57e3e93bf09d7f8b = function() { return logError(function (arg0, arg1) {
        // Cast intrinsic for `Closure(Closure { dtor_idx: 20, function: Function { arguments: [NamedExternref("Event")], shim_idx: 18, ret: Unit, inner_ret: Some(Unit) }, mutable: false }) -> Externref`.
        const ret = makeClosure(arg0, arg1, 20, __wbg_adapter_6);
        return ret;
    }, arguments) };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('vgapalette_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
